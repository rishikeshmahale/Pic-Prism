...
const PhotoManagement = () => {
  ...
  const getMyPosts = async () => {
    try {
      ...
      console.log("data from myPosts API : ", data);
  ...
  return (
    <div className="flex flex-col sm:flex-row">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 gap-5 mt-5 bg-transparent sm:bg-white p-5 w-[90vw] sm:w-[55vw] sm:h-[95vh] sm:overflow-y-scroll rounded-lg mx-auto sm:mx-0">
        {posts.length > 0 &&
